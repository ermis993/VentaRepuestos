...
Public Class Imprime_proforma
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VentaRepuestos.Imprime_proforma.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NUMERO_DOC() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedImprime_proforma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Imprime_proforma = New Imprime_proforma()
        rpt.Site = Me.Site
        Return rpt
    End Function
