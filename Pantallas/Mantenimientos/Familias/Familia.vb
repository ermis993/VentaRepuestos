...
Public Class Familia
    ...
    Private Sub RELLENAR_GRID()
        Try
            If GRID.Columns.Count > 0 Then
                ...
                Dim SQL = "	SELECT CODIGO As Código,DESCRIPCION As Descripción, ESTADO AS Estado"
    ...
    Private Sub Modificar()
        Try
            If Me.GRID.Rows.Count > 0 Then
                ...
                Else
                    Dim PANTALLA As New FamiliaMant(CRF_Modos.Modificar, Me, CODIGO)
                    PANTALLA.ShowDialog()
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub BTN_AGREGAR_Click(sender As Object, e As EventArgs) Handles BTN_AGREGAR.Click
        Dim PANTALLA As New FamiliaMant(CRF_Modos.Insertar, Me)
        PANTALLA.ShowDialog()
    End Sub
End Class